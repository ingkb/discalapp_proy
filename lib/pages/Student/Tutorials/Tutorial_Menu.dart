    ...
    return Center(
      child: Container(
        ...
        child: GridView.count(
          ...
          children: [
            botonNivel("Sumas", 'videoReproducer', context, 1),
            botonNivel("Restas", 'videoReproducer', context, 2),
            botonNivel("Multiplicación", 'videoReproducer', context, 3),
            botonNivel("Comparación", 'videoReproducer', context, 4),
            botonNivel("Secuencias", 'videoReproducer', context, 5),
            botonNivel("Prop. Asociativa", 'videoReproducer', context, 6),
            botonNivel("Recta Numérica", 'videoReproducer', context, 7),
          ],
        ),
      ),
    );
